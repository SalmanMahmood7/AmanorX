    ...
    <div>
            ...
            <button
              ...
              className={`flex min-w-16 cursor-pointer flex-col items-center border-2 px-3 py-2 transition-colors duration-200 ${
                selected
                  ...
                  : "border-navy-900/10 bg-white text-navy-900 hover:border-gold-500/50"
              }`}
            >
      ...
      {steps.map((step, index) => (
        <div
          ...
          className="mx-auto mt-6 max-w-2xl rounded-lg border border-t-2 border-navy-900/10 border-t-gold-500 bg-white p-6 text-center sm:p-7"
        >
