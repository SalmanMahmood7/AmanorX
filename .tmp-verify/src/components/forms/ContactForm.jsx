    ...
    <form onSubmit={handleSubmit} className="space-y-4" noValidate>
      ...
      <div>
        ...
        <input
          ...
          type="text"
          required
          className="mt-1 w-full rounded-lg border border-white/15 bg-white/5 px-3 py-2 text-sm text-white transition-colors placeholder:text-white/40 focus:border-gold-400/60 focus-visible:outline focus-visible:outline-2 focus-visible:outline-gold-400"
        />
      </div>
      ...
      {lockReason ? (
        ...
        <div>
          ...
          <select
            ...
            className="mt-1 w-full cursor-pointer rounded-lg border border-white/15 bg-navy-900 px-3 py-2 text-sm text-white transition-colors focus:border-gold-400/60 focus-visible:outline focus-visible:outline-2 focus-visible:outline-gold-400"
          >
            {reasons.map((reason) => (
