...
export default function WhyAmanorXBenefits({ heading, cards }) {
  ...
  return (
    <section className="relative w-full bg-navy-950 px-4 py-12 sm:px-6 sm:py-20 md:px-10">
      <AnimatedHeading
        startOnView
        as="h2"
        text={heading}
      ...
      <div className="grid grid-cols-1 gap-3 sm:gap-4 md:grid-cols-3">
        ...
        <Reveal className="relative h-[380px] overflow-hidden rounded-2xl bg-neutral-950 p-6 sm:h-[460px] sm:p-8">
          <div
            aria-hidden="true"
            className="absolute top-1/2 -left-[420px] h-[460px] w-[460px] -translate-y-1/2 rounded-full bg-gold-500 opacity-40 blur-3xl"
          />
        ...
        >
          <div
            aria-hidden="true"
            className="absolute -top-28 -right-28 h-56 w-56 rounded-full bg-gold-500 opacity-40 blur-3xl"
          />
          <div className="relative z-10 flex h-full flex-col items-center text-center">
