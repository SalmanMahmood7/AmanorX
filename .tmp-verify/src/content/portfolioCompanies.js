...
//
// `onHomepageWall: false` keeps a company off the homepage portfolio logo
// wall only -- it still appears on the /portfolio page and in the group
