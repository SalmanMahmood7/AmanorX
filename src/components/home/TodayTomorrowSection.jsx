  ...
  return (
    <Link
      ...
      className={`group flex items-start justify-between gap-3 rounded-2xl p-4 shadow-[0_3px_9px_rgba(63,74,126,0.05),0_1px_20px_rgba(63,74,126,0.08)] transition-colors duration-200 ${
        dashed
          ? "border border-dashed border-navy-900/15 bg-navy-50/60 hover:border-gold-500/50"
          : "bg-white hover:bg-navy-50"
      }`}
    >
      <div>
        <p className="text-sm font-medium text-navy-900 transition-colors group-hover:text-gold-600">
          {sector.name}
        </p>
